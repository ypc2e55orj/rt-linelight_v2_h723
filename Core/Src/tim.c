...
void MX_TIM1_Init(void)
{
  ...
  htim1.Init.Period = 200000000 / 100000 - 1;
...
void MX_TIM2_Init(void)
{
  ...
  htim2.Init.Period = 200000000 / 100000 - 1;
...
void MX_TIM5_Init(void)
{
  ...
  htim5.Init.Period = (200000000 / 200) / 4000 - 1;
...
void MX_TIM23_Init(void)
{
  ...
  htim23.Init.Period = (200000000 / 200) / 1000 - 1;
...
void HAL_TIM_OnePulse_MspInit(TIM_HandleTypeDef* tim_onepulseHandle)
{
  ...
  if(tim_onepulseHandle->Instance==TIM8)
  {
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PE14     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = PWM1_IN1_Pin|PWM1_IN2_Pin|PWM0_IN1_Pin|PWM0_IN2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PB11     ------> TIM2_CH4
    */
    GPIO_InitStruct.Pin = SUCTION_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(SUCTION_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD13     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOD, ENC0_B_Pin|ENC0_A_Pin);
